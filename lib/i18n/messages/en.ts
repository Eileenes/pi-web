...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.tabLabel": "Terminal {n}",
    "terminal.closeTab": "Close Terminal",
    "terminal.tabCwd": "CWD: {cwd}",
    "terminal.toggleShortcut": "Toggle terminal (Ctrl+`)",
    "terminal.cdTo": "→ {path}",
    "terminal.cdFailed": "cd: cannot resolve path: {path}",
    "terminal.cdOlderPwd": "cd: OLDPWD not set",
    ...
    "skin.voyage": "Voyage",
    "skin.myth": "Dark Myth",
    "skin.wanxiang": "Wanxiang",
    "skin.darkMode": "Dark mode",
    "skin.lightMode": "Light mode",
    "scm.title": "Source Control",
    "scm.sidebarLabel": "Git",
    "scm.back": "Back to sessions",
    "scm.refresh": "Refresh",
    "scm.switchBranch": "Switch branch",
    "scm.status.modified": "Modified",
    "scm.status.added": "Added",
    "scm.status.deleted": "Deleted",
    "scm.status.renamed": "Renamed",
    "scm.status.untracked": "Untracked",
    "scm.status.conflict": "Conflict",
    ...
    "scm.push": "Push",
    "scm.history": "History",
    "scm.pulled": "Pulled latest changes",
    "scm.stagedAll": "Staged all changes",
    "scm.discardedAll": "Discarded all changes",
    "scm.justNow": "just now",
    "scm.minutesAgo": "{count}m ago",
    "scm.hoursAgo": "{count}h ago",
    "scm.daysAgo": "{count}d ago",
    "scm.noCommits": "No commits yet",
    "scm.select": "Select",
    "scm.deselect": "Deselect",
    "scm.selectAll": "Select All",
    "scm.clearSelection": "Clear selection",
    "scm.selectedN": "{count} selected",
    "scm.stagedN": "Staged {count} file(s)",
    "scm.unstagedN": "Unstaged {count} file(s)",
    "scm.discardNConfirm": "Discard changes to {count} selected file(s)? This cannot be undone.",
    "scm.discardedN": "Discarded {count} file(s)",
    "scm.stageGroup": "Stage Group",
    "scm.unstageAll": "Unstage All",
    "scm.unstage": "Unstage",
    "scm.discard": "Discard Changes",
    "scm.discardConfirm": "Discard changes to {file}? This cannot be undone.",
    "scm.openDiff": "Open diff",
    "scm.loading": "Loading...",
    "scm.noChanges": "No changes",
    "scm.notRepo": "This folder is not a git repository",
    "scm.selectProject": "Select a project to view its changes",
    "scm.noBranches": "No branches found",
    "scm.newBranchPlaceholder": "New branch name...",
    "scm.createBranch": "Create",
    "scm.deleteBranch": "Delete branch",
    "scm.deleteBranchConfirm": "Delete branch {branch}?",
    "scm.branchDeleted": "Deleted branch {branch}",
    "scm.commitPlaceholder": "Message (⌘Enter to commit)",
    "scm.commit": "Commit",
    "scm.commitAndPush": "Commit & Push",
    "scm.commitAndPushTitle": "Commit and push to remote",
    "scm.committing": "Working...",
    "scm.committed": "Committed",
    "scm.pushed": "Committed and pushed",
    "scm.nothingStaged": "Stage changes before committing",
    "scm.stageAllAndCommitConfirm": "Nothing is staged. Stage all changes and commit directly?",
    "scm.stageAllAndCommitHint": "Nothing staged — committing will stage all changes first",
    "scm.generateMessage": "AI Generate",
    "scm.generating": "Generating...",
    "scm.generatingPlaceholder": "Analyzing changes, generating commit message...",
    "scm.generatingStatus": "Analyzing changes and generating a commit message...",
    "scm.messageGenerated": "Commit message generated — review and commit",
    "scm.generateFailed": "Generation failed — please try again",
    "activitybar.label": "Activity Bar",
    "activitybar.sessions": "Sessions",
    "scm.tabChanges": "Changes",
    "scm.tabHistory": "History",
    "scm.allBranches": "All Branches",
    ...
    "scm.noFileChanges": "This commit has no file changes",
    "scm.viewFileDiff": "View file diff in this commit",
    "scm.loadFailed": "Failed to load",
    "directoryPicker.systemPicker": "Choose folder with the system picker",
    "directoryPicker.systemPickerShort": "System",
    "i18n.revealInFinder": "Show in Finder",
    "i18n.diffScope": "Compare against",
    "i18n.diffUnstaged": "Unstaged",
    "i18n.diffStaged": "Staged",
    "i18n.copyDiff": "Copy diff",
    "notify.agentDoneTitle": "Pi Web",
    "notify.agentDoneBody": "Agent finished",
