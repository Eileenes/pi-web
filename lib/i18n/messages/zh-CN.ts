...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.tabLabel": "终端 {n}",
    "terminal.closeTab": "关闭终端",
    "terminal.tabCwd": "工作目录：{cwd}",
    "terminal.toggleShortcut": "切换终端 (Ctrl+`)",
    "terminal.cdTo": "→ {path}",
    "terminal.cdFailed": "cd: 无法解析路径：{path}",
    "terminal.cdOlderPwd": "cd: 上一个目录未设置",
    "common.language": "语言",
    "common.models": "模型",
    "common.skills": "技能",
    "common.plugins": "插件",
    ...
    "scm.back": "返回会话",
    "scm.refresh": "刷新",
    "scm.switchBranch": "切换分支",
    "scm.status.modified": "已修改",
    "scm.status.added": "已新增",
    "scm.status.deleted": "已删除",
    "scm.status.renamed": "已重命名",
    "scm.status.untracked": "未跟踪",
    "scm.status.conflict": "冲突",
    "scm.staged": "暂存的更改",
    "scm.unstaged": "更改",
    "scm.untracked": "未跟踪",
    "scm.stage": "暂存",
    "scm.stageAll": "暂存全部更改",
    "scm.discardAll": "全部放弃",
    "scm.discardAllConfirm": "放弃所有更改？此操作无法撤销。",
    "scm.pull": "拉取",
    "scm.push": "推送",
    "scm.history": "历史",
    "scm.pulled": "已拉取最新更改",
    "scm.stagedAll": "已暂存全部更改",
    "scm.discardedAll": "已放弃所有更改",
    "scm.justNow": "刚刚",
    "scm.minutesAgo": "{count} 分钟前",
    "scm.hoursAgo": "{count} 小时前",
    "scm.daysAgo": "{count} 天前",
    "scm.noCommits": "暂无提交",
    "scm.select": "选择",
    "scm.deselect": "取消选择",
    "scm.selectAll": "全选",
    "scm.clearSelection": "清除选择",
    "scm.selectedN": "已选 {count} 项",
    "scm.stagedN": "已暂存 {count} 个文件",
    "scm.unstagedN": "已取消暂存 {count} 个文件",
    "scm.discardNConfirm": "放弃选中的 {count} 个文件的更改？此操作无法撤销。",
    "scm.discardedN": "已放弃 {count} 个文件的更改",
    "scm.stageGroup": "暂存本组",
    "scm.unstageAll": "全部取消暂存",
    "scm.unstage": "取消暂存",
    "scm.discard": "放弃更改",
    "scm.discardConfirm": "放弃 {file} 的更改？此操作无法撤销。",
    "scm.openDiff": "查看差异",
    "scm.loading": "加载中...",
    "scm.noChanges": "没有更改",
    "scm.notRepo": "该目录不是 Git 仓库",
    "scm.selectProject": "选择项目以查看更改",
    "scm.noBranches": "未找到分支",
    "scm.newBranchPlaceholder": "新分支名...",
    "scm.createBranch": "创建",
    "scm.deleteBranch": "删除分支",
    "scm.deleteBranchConfirm": "删除分支 {branch}？",
    "scm.branchDeleted": "已删除分支 {branch}",
    "scm.commitPlaceholder": "提交消息（⌘Enter 提交）",
    "scm.commit": "提交",
    "scm.commitAndPush": "提交并推送",
    "scm.commitAndPushTitle": "提交并推送到远程",
    "scm.committing": "处理中...",
    "scm.committed": "已提交",
    "scm.pushed": "已提交并推送",
    "scm.nothingStaged": "提交前请先暂存更改",
    "scm.stageAllAndCommitConfirm": "暂存区为空，是否暂存所有更改并直接提交？",
    "scm.stageAllAndCommitHint": "暂存区为空——提交时将自动暂存所有更改",
    "scm.generateMessage": "AI 生成提交信息",
    "scm.generating": "生成中...",
    "scm.generatingPlaceholder": "正在分析变更，生成提交信息...",
    "scm.generatingStatus": "正在分析变更并生成提交信息...",
    "scm.messageGenerated": "已生成提交信息，可编辑后提交",
    "scm.generateFailed": "生成失败，请重试",
    "activitybar.label": "活动栏",
    "activitybar.sessions": "会话",
    "scm.tabChanges": "更改",
    "scm.tabHistory": "历史",
    "scm.allBranches": "所有分支",
    ...
    "scm.author": "作者",
    "scm.commitTime": "提交时间",
    "scm.noFileChanges": "该提交没有文件变更",
    "scm.viewFileDiff": "查看该提交中的文件差异",
    "scm.loadFailed": "加载失败",
    "directoryPicker.systemPicker": "使用系统选择器选择文件夹",
    "directoryPicker.systemPickerShort": "系统",
    "i18n.revealInFinder": "在 Finder 中显示",
    "i18n.diffScope": "对比范围",
    "i18n.diffUnstaged": "未暂存",
    "i18n.diffStaged": "已暂存",
    "i18n.copyDiff": "复制 diff",
    "notify.agentDoneTitle": "Pi Web",
    "notify.agentDoneBody": "任务已完成",
    "history.full": "完整历史",
